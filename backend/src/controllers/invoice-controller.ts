...
export const updateInvoice = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    if (validatedData.companyLogo !== undefined)
      updateData.companyLogo = validatedData.companyLogo;
    ...
    if (validatedData.companyAddress !== undefined)
      updateData.companyAddress = validatedData.companyAddress;
    if (validatedData.clientName !== undefined)
      updateData.clientName = validatedData.clientName;
    if (validatedData.clientAddress !== undefined)
      updateData.clientAddress = validatedData.clientAddress;
    if (validatedData.currency !== undefined)
      updateData.currency = validatedData.currency;
    if (validatedData.theme !== undefined)
      updateData.theme = validatedData.theme;
    if (validatedData.invoicePrefix !== undefined)
      updateData.invoicePrefix = validatedData.invoicePrefix;
    ...
    if (validatedData.billingDetails !== undefined)
      updateData.billingDetails = validatedData.billingDetails;
    if (validatedData.labelTypeValue !== undefined)
      updateData.labelTypeValue = validatedData.labelTypeValue;
